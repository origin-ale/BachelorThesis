...
\begin{definition}
  ...
  \end{equation} 
  Si dice \dfn{azione} di un moto $\vec{x}:t\mapsto \vec{x}(t)$ tra i tempi $t_0$ e $t_1 \in \R$ l'integrale della lagrangiana nel tempo \begin{equation} \label{eq:action}
