...
Si nota per completezza che la trattazione di alcuni sistemi richiede l'introduzione di un termine di \dfn{potenziale generalizzato} dipendente linearmente dalla velocità. In questo elaborato, tale classe di sistemi non verrà tuttavia trattata.
