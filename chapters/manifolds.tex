...
\begin{aligned}
  ...
  &= \eval{\pdv{\hat{f}}{x_i}}_{\phi(x)} \equiv \eval{\pdv{x_i}}_x f \equiv \eval{\partial_i}_x f
\end{aligned}
\end{equation*} 
...
\end{remark}
\begin{remark}
  Se il vettore tangente è invece visto come una derivazione direzionale $\hat{\gamma}$ su $X$, il push-forward la porta nella derivazione $f^*_x \hat{\gamma}$ su $Y$ tale che per ogni $g:Y\to \R$ valga
  \begin{equation*}
...
Così come è possibile costruire campi vettoriali su una varietà, è anche possibile costruirvi campi di vettori cotangenti.
