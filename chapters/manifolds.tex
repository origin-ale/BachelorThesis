...
\begin{definition} \label{def:tanBundle}
  ...
  \end{equation} 
  dove $v \in \R^{n}$ è il vettore reale corrispondente a $\gamma$ secondo la carta $\phi$ (\autoref{eq:tangentRnBase}).
\end{definition}
